...
begin
    select count(*) into c_1 from mytable where item = 'i_1';
    select count(*) into c_2 from mytable where item = 'i_2';
    select count(*) into c_3 from mytable where item = 'i_3';
    select count(distinct(item)) into c_group from mytable;
